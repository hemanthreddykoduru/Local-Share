...
const HERO_CHARACTERS = [
    ...
    'Black Panther', 'T\'Challa', 'Scarlet Witch', 'Wanda Maximoff', 'Vision', 
    ...
    'Mantis', 'Okoye', 'Shuri', 'Nebula', 
    'Rocket Raccoon', 'Rocket', 'Groot', 'Drax', 'Drax the Destroyer',
    'Star-Lord', 'Peter Quill', 'Gamora', 'Wong',
