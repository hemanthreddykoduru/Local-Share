                    ...
                    <div className="bg-gray-50 rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col md:flex-row gap-8 items-center md:items-start max-w-2xl mx-auto">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <div className="flex items-center gap-4">
                                <a href="https://linkedin.com/in/hemanthreddykoduru" target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors flex items-center gap-2 text-sm font-bold">
