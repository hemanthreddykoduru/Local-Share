                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white border border-gray-200 rounded-[24px] shadow-sm">
                            ...
                            {/* Table Header */}
                            <div className="bg-[#F9FAFB] px-8 py-3 hidden md:grid grid-cols-12 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            ...
                            <div className="divide-y divide-gray-100">
                                {projects.length === 0 ? (
                                    ...
                                    projects.map((project) => (
                                        <div key={project.id} className="px-6 md:px-8 py-6 md:py-4 flex flex-col md:grid md:grid-cols-12 md:items-center hover:bg-gray-50 transition-colors last:rounded-b-[24px] gap-4 md:gap-0">
                                            <div className="md:col-span-2 flex items-center justify-between md:block">
                                                <span className="text-[10px] font-black uppercase text-gray-400 md:hidden">Status</span>
                                            ...
                                            <div className="md:col-span-4 flex flex-col md:flex-row md:items-center gap-2 truncate pr-4">
                                                <span className="text-[10px] font-black uppercase text-gray-400 md:hidden">Project URL</span>
                                                <div className="flex items-center gap-2">
                                            ...
                                            <div className="md:col-span-2 flex items-center justify-between md:block">
                                                <span className="text-[10px] font-black uppercase text-gray-400 md:hidden">Modified</span>
                                                <div className="text-sm text-gray-600">
                                                    {formatDate(project.created_at)}
                                                </div>
                                            </div>
                                            <div className="md:col-span-2 flex items-center justify-between md:block">
                                                <span className="text-[10px] font-black uppercase text-gray-400 md:hidden">Views</span>
                                                <div className="text-sm text-gray-600 font-bold">
                                                    {project.views || 0}
                                                </div>
                                            </div>
                                            <div className="md:col-span-2 flex items-center justify-between md:justify-end gap-3 text-gray-500 relative mt-2 md:mt-0 pt-4 md:pt-0 border-t md:border-0 border-gray-100">
                                                <span className="text-[10px] font-black uppercase text-gray-400 md:hidden">Actions</span>
                                                <div className="flex items-center gap-3">
                ...
                <div className="fixed inset-0 z-[130] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm animate-fade-in">
                    <div className="bg-white rounded-[40px] w-full max-w-md p-10 shadow-2xl animate-slide-up border border-gray-100 text-center">
                        ...
                        <div className="flex flex-col gap-3">
                            <Link 
                                href="/login"
                                className="w-full py-4 bg-gray-900 hover:bg-black text-white font-bold rounded-2xl shadow-xl transition-all flex items-center justify-center"
                            >
                                Get started
                            </Link>
                            <button 
