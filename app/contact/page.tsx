                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">hemanth@local-share.tech</p>
                                        <p className="text-sm text-gray-500">Contact the founder directly for urgent inquiries</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 pt-4 border-t border-gray-50">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600"><a href="https://linkedin.com/in/hemanthreddykoduru" className="text-primary-600 hover:underline">Hemanth Reddy</a></p>
                                        <p className="text-sm text-gray-500">Engineering student @ GITAM Bengaluru</p>
                                    </div>
                                </div>
